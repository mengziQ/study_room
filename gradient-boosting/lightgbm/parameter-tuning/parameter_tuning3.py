...
# max_depth, min_child_weight, gamma, subsample, colsample_bytreeをチューニングするスクリプト。
...
params = {
  ...
  'n_estimators': 1000,
  'max_bin': 255,
  'subsample_for_bin': 200, # bin_construct_sample_cntn
...
grid_params = {
  'learning_rate': [0.05, 0.025, 0.0125]
}
